 ...
 * LoginRedirectFilter.LOGIN_URL_PARAM - url страницы на которую будет перенаправлен не авторизованный запрос. Путь
 ...
 *
 * LoginRedirectFilter.EXCLUDED_URLS_PARAM - список регулярных выражений разделенных переводом строки. Запросы на адреса
 * соответствующие хотя бы одному выражению будут пропускаться через фильтр, даже если они не авторизованны. При компиляции
 * выражений к ним добавляется текущий contextRoot(аналогично  LoginRedirectFilter.LOGIN_URL_PARAM).
 */
public class LoginRedirectFilter implements Filter {
    public static final String LOGIN_URL_PARAM = "ru.simplgroupp.servlet.LoginRedirectFilter.loginUrl";
    public static final String EXCLUDED_URLS_PARAM = "ru.simplgroupp.servlet.LoginRedirectFilter.excludedURIs";
